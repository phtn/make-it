...
const MenuIcon = tw(Menu)`
  h-5 w-5 text-neutral-100 hover:text-cyan-50 hover:scale-[115%] transition-all duration-500 
`;
...
const ItemWrap = tw(Link)<{ $index: number }>`
  ${(p) =>
    p.$index === 4
      ...
      : "col-span-1 from-indigo-600 to-indigo-500 dark:from-sky-600 dark:to-sky-500 text-left text-[1.2rem] leading-[1.05rem] pl-4 pr-9"}
